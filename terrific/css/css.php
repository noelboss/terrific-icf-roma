...
$output .= file_get_contents(TERRIFIC_DIR . '/css/libraries/oocss/libraries.css');
$output .= file_get_contents(TERRIFIC_DIR . '/css/libraries/oocss/template.css');
$output .= file_get_contents(TERRIFIC_DIR . '/css/libraries/oocss/grids.css');
$output .= file_get_contents(TERRIFIC_DIR . '/css/libraries/oocss/mod.css');

// load elements css
$output .= file_get_contents(TERRIFIC_DIR . '/elements/css/elements.css');
$output .= file_get_contents(TERRIFIC_DIR . '/elements/fonts/fonts.css');
